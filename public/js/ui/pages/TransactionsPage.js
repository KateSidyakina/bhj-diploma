...
class TransactionsPage {
  ...
  registerEvents() {
    ...
    const removeTransactionButtons = document.querySelectorAll('.transaction__remove');

    removeAccountButton.addEventListener('click', () => {
      this.removeAccount();
    });

    for (let button of removeTransactionButtons) {
  ...
  removeTransaction( id ) {
    let confirmation = confirm('Вы действительно хотите удалить транзакцию?');
  ...
  formatDate(date){
    ...
    return `${formatedDate.getDate()} ${monthNames[formatedDate.getMonth()]} ${formatedDate.getFullYear()} г. в ${normalizeTime(formatedDate.getHours())}:${normalizeTime(formatedDate.getMinutes())}`;
  }
